...
final readonly class AssertionNot implements Assertable
{
    ...
    public function positive(): void
    {
        (new IsPositive(
            actual: $this->value,
            pattern: 'Expected a non-positive number. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function negative(): void
    {
        (new IsNegative(
            actual: $this->value,
            pattern: 'Expected a non-negative number. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function zero(): void
    {
        (new IsZero(
            actual: $this->value,
            pattern: 'Expected a non-zero value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function greaterThanOrEqualTo(int|float $limit): void
    {
        (new IsGreaterThanOrEqualTo(
            $this->value,
            $limit,
            'Expected a value not greater than or equal to %s. Got: %s',
            true
        ))->evaluate();
    }
    ...
    public function lessThanOrEqualTo(int|float $limit): void
    {
        (new IsLessThanOrEqualTo(
            $this->value,
            $limit,
            'Expected a value not less than or equal to %s. Got: %s',
            true
        ))->evaluate();
    }
    ...
    public function between(int|float $min, int|float $max): void
    {
        (new IsBetween(
            ...
            $min,
            $max,
            'Expected value not between %s and %s. Got: %s',
            true
        ))->evaluate();
    }
    ...
    public function odd(): void
    {
        (new IsOdd(
            actual: $this->value,
            pattern: 'Expected a non-odd integer. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function even(): void
    {
        (new IsEven(
            actual: $this->value,
            pattern: 'Expected a non-even integer. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function divisibleBy(int|float $divisor): void
    {
        (new IsDivisibleBy(
            $this->value,
            $divisor,
            'Expected value not to be divisible by %s. Got: %s',
            true
        ))->evaluate();
    }
    ...
    public function stringNotEmpty(): void
    {
        (new IsNotEmpty(
            actual: $this->value,
            pattern: 'Expected an empty string',
            negative: true
        ))->evaluate();
    }
    ...
    public function stringLength(int $expected): void
    {
        (new HasLength(
            $this->value,
            $expected,
            'Expected string not of length %d. Got: %d',
            true
        ))->evaluate();
    }
    ...
    public function stringMinLength(int $min): void
    {
        (new HasMinLength(
            $this->value,
            $min,
            'Expected string with length less than %d. Got: %d',
            true
        ))->evaluate();
    }
    ...
    public function stringMaxLength(int $max): void
    {
        (new HasMaxLength(
            $this->value,
            $max,
            'Expected string with length greater than %d. Got: %d',
            true
        ))->evaluate();
    }
    ...
    public function stringMatches(string $pattern): void
    {
        (new Matches(
            $this->value,
            $pattern,
            'Expected string not to match pattern "%s". Got: %s',
            true
        ))->evaluate();
    }
    ...
    public function validEmail(): void
    {
        (new IsEmail(
            actual: $this->value,
            pattern: 'Expected a non-email value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function validUrl(): void
    {
        (new IsUrl(
            actual: $this->value,
            pattern: 'Expected a non-URL value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function validUuid(): void
    {
        (new IsUuid(
            actual: $this->value,
            pattern: 'Expected a non-UUID value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function uppercase(): void
    {
        (new IsUppercase(
            actual: $this->value,
            pattern: 'Expected a non-uppercase string. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function lowercase(): void
    {
        (new IsLowercase(
            actual: $this->value,
            pattern: 'Expected a non-lowercase string. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function alpha(): void
    {
        (new IsAlpha(
            actual: $this->value,
            pattern: 'Expected a string not containing only letters. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function alphanumeric(): void
    {
        (new IsAlphanumeric(
            actual: $this->value,
            pattern: 'Expected a string not containing only letters and digits. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function base64(): void
    {
        (new IsBase64(
            actual: $this->value,
            pattern: 'Expected a non-base64 string. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function notBlank(): void
    {
        (new IsNotBlank(
            actual: $this->value,
            pattern: 'Expected a blank string. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function validIp(): void
    {
        (new IsIp(
            actual: $this->value,
            pattern: 'Expected a non-IP value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function hexColor(): void
    {
        (new IsHexColor(
            actual: $this->value,
            pattern: 'Expected a non-hex-color value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function slug(): void
    {
        (new IsSlug(
            actual: $this->value,
            pattern: 'Expected a non-slug value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function truthy(): void
    {
        (new IsTruthy(
            actual: $this->value,
            pattern: 'Expected a non-truthy value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function falsy(): void
    {
        (new IsFalsy(
            actual: $this->value,
            pattern: 'Expected a non-falsy value. Got: %s',
            negative: true
        ))->evaluate();
    }
    ...
    public function containsValue(mixed $value): void
    {
        (new ContainsValue(
            $this->value,
            $value,
            'Expected array not to contain value %s',
            true
        ))->evaluate();
    }
    ...
    public function inArray(array $haystack): void
    {
        (new InArray(
            $this->value,
            $haystack,
            'Expected %s not to be in the provided array',
            true
        ))->evaluate();
    }
    ...
    public function arrayMinCount(int $min): void
    {
        (new HasMinCount(
            $this->value,
            $min,
            'Expected fewer than %d elements. Got: %d',
            true
        ))->evaluate();
    }
    ...
    public function arrayMaxCount(int $max): void
    {
        (new HasMaxCount(
            $this->value,
            $max,
            'Expected more than %d elements. Got: %d',
            true
        ))->evaluate();
    }
    ...
    public function sorted(): void
    {
        (new IsSorted(
            actual: $this->value,
            pattern: 'Expected array not to be sorted in ascending order',
            negative: true
        ))->evaluate();
    }
    ...
    public function sortedDescending(): void
    {
        (new IsSortedDescending(
            actual: $this->value,
            pattern: 'Expected array not to be sorted in descending order',
            negative: true
        ))->evaluate();
    }
    ...
    public function unique(): void
    {
        (new IsUnique(
            actual: $this->value,
            pattern: 'Expected array to contain duplicate values',
            negative: true
        ))->evaluate();
    }
}
